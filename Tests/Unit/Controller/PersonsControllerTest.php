...
/**
 * Test case for class He\HePersonen\Controller\PersonsController.
 *
 */
class PersonsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \He\HePersonen\Controller\PersonsController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('He\\HePersonen\\Controller\\PersonsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPersonssFromRepositoryAndAssignsThemToView()
	{
		...
		$personsRepository = $this->getMock('He\\HePersonen\\Domain\\Repository\\PersonsRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$persons = new \He\HePersonen\Domain\Model\Persons();
	...
	public function createActionAddsTheGivenPersonsToPersonsRepository()
	{
		...
		$personsRepository = $this->getMock('He\\HePersonen\\Domain\\Repository\\PersonsRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenPersonsInPersonsRepository()
	{
		...
		$personsRepository = $this->getMock('He\\HePersonen\\Domain\\Repository\\PersonsRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenPersonsFromPersonsRepository()
	{
		...
		$personsRepository = $this->getMock('He\\HePersonen\\Domain\\Repository\\PersonsRepository', array('remove'), array(), '', FALSE);
